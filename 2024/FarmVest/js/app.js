(() => {
    ...
    function menuInit(speedAnimation = 500) {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                bodyLockToggle(speedAnimation);
                document.documentElement.classList.toggle("menu-open");
            }
        }));
    }
    function menuClose(delay = 500) {
        bodyUnlock(delay);
        ...
        if (targetBlockElement) {
            ...
            if (noHeader) {
                ...
                if (!headerElement.classList.contains("_header-scroll")) {
                    const headerContent = headerElement.querySelector(".header__content");
                    headerContent.style.cssText = `transition-duration: 0s;`;
    ...
    Parallax.Each = class {
        ...
        animationFrame() {
            ...
            if (positionParent.top < 300 && positionParent.bottom > -300) switch (centerPoint) {
              case "top":
            ...
            this.elements.forEach((el => {
                const parameters = {
                    ...
                    coefficient: el.dataset.coefficient ? parseInt(el.dataset.coefficient) : 5,
    ...
    function windowLoaded() {
        ...
        mediaTheme.addEventListener("change", changeColor);
        changeColor(mediaTheme);
    }
    function changeOrientation(event) {
        if (event.matches && document.documentElement.classList.contains("menu-open") && window.innerWidth > 767.98) menuClose(0);
    }
